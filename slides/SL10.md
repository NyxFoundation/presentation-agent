...
<div class="grid grid-cols-3 gap-4 mt-4">
  <div class="bg-green-50 rounded-xl p-4 border border-green-200">
    ...
    <div class="text-sm mt-2">
      ...
      <div class="font-semibold">再現性</div>
    </div>
    <div class="text-sm mt-2">
      <div class="text-gray-600 mb-1">得られる知見:</div>
      <div>現実環境に沿った実データ</div>
    </div>
  </div>
...
<div class="mt-4">
  ...
  <div class="grid grid-cols-4 gap-3 text-sm">
    ...
    <div class="bg-amber-50 rounded-lg p-3 border border-amber-200">
      <div class="font-semibold text-amber-800">追加実験の容易性</div>
      <div class="text-xs text-gray-600 mt-1">データさえあれば何度でも追加実験が可能</div>
    </div>
  </div>
</div>
...
L0のブロックチェーン層では、現実環境に沿った実データが得られ、再現性を担保できます。
...
特にユニークなのは4つの点です。制度と主体の不可分性—制度の効果は主体のアーキテクチャに依存します。操作変数の自由度—AIだけの環境なら能力や性格、倫理観まで操作可能です。データの希少性—この実験データ自体が貴重な論文・技術資産になります。そして追加実験の容易性—データさえあれば何度でも追加実験が可能です。
-->
