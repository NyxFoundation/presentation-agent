...
- encrypted mempool: threshold 暗号で tx を包み、ブロック取り込みまで validator にも中身が見えない。図のロゴは Shutter Network — 「shutterized」mempool が Gnosis Chain でメインネット稼働中 (Ethereum L1 へはロードマップ文書段階)。
